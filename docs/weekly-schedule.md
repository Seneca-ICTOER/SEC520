...
| Learning Objectives and Tasks | Course Notes / Assigned Reading | Labs/Evaluations |
| --- | --- | --- |
| **Scanning, Enumeration, & Vulnerability Testing:** | **Slides (Concepts):** [\[odp\]](/slides/sec520_w2_l1.odp) [\[pdf\]](/slides/sec520_w2_l1.pdf) [\[ppt\]](/slides/sec520_w2_l1.ppt) Scanning & Enumeration | [Lab 3: Penetration Testing Continued: Scanning, Enumeration, & Vulnerability Testing](/A-Labs/lab3.md) |
| - Penetration Testing (Continued): | **Reading References:** [Penetration Tester's Open Source Toolkit (E-book)](http://libcat.senecac.on.ca/vwebv/holdingsInfo?searchId=89542&recCount=50&recPointer=0&bibId=315433) (Chapter 3) |  |
|     - Scanning | **YouTube Videos:** |  |
|     - Enumeration | - [Scanning 1](http://www.youtube.com/watch?v=_Ch0RJlHFBo), [Scanning 2](http://www.youtube.com/watch?v=WKLNAAt57Wg) |  |
| - Vulnerability Testing | - [Enumeration](http://www.youtube.com/watch?v=_Ch0RJlHFBo) |  |
|  | - [Online Pen-Test Scanner](https://pentest-tools.com/network-vulnerability-scanning/tcp-port-scanner-online-nmap) |  |
|  | - [Prep for Metasploit](https://www.youtube.com/watch?v=dR7NTYfmNcA) |  |
|  | **Resources:** [Nmap Reference Guide](http://nmap.org/book/man.html) (How to use **nmap** utility to scan ports) |  |
...
|  | - [Nessus](https://www.youtube.com/watch?v=lNjxwvQT-os) |  |
|  | - [Accessing System Via Metasploit (web-browser)](https://www.youtube.com/watch?v=hRxOW37MRwc) |  |
|  | **Resources:** |  |
|  | - [Setting up the Metasploit database](https://www.youtube.com/watch?v=r4Qq2eVjiP0) |  |
|  | - [First Metasploit Payload](https://www.youtube.com/watch?v=x01ZErjNlX0) |  |
|  | - [Using Armitage](http://www.youtube.com/watch?v=jJd5qg3fkyw) (Metasploit Framework) |  |
